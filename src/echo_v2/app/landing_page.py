  ...
  <div class="container">
    ...
    <div class="step">
      ...
      <div>
        ...
        <p>שולחים ל־Echo הודעה, מקבלים קוד חד־פעמי ומזינים אותו בוואטסאפ (הגדרות ← מכשירים מקושרים). בלי סריקת QR, בלי להתקין שום דבר, ובתוך דקה־שתיים מחוברים — דרך Green API.</p>
      </div>
    </div>
    <div class="step">
      <div class="num">2</div>
